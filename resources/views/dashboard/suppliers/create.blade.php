            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('dashboard.hotel.supplier.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" name="contact_person_name" required value="{{ old('contact_person_name') }}"
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" name="contact_person_phone" required value="{{ old('contact_person_phone') }}"
