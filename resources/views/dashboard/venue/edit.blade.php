            ...
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('dashboard.hotel.venue.update', $venue->id) }}" method="POST">
                            @csrf @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                                    ...
                                    <input type="text" name="name" required value="{{ old('name', $venue->name) }}"
                                ...
                                <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 room mb-3" id="room1">
                                    ...
                                    <input type="number" name="rate" required value="{{ old('rate', $venue->rate) }}"
                                ...
                                <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 mb-3">
                                    ...
                                    <input id="rate_0" name="discounted_rate"  class="form-control @error('description') is-invalid @enderror" type="number" onkeyup="updateAmount(0)"
                                        inputmode="decimal" min="0" value="{{ old('discounted_rate', $venue->discounted_rate) }}"
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                        id="input1" placeholder="Description">{{ old('description', $venue->description) }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
